  ...
  return (
    <div className="bg-black">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className=" flex flex-wrap justify-evenly gap-6 items-center">
          <div className="bg-gradient-to-r w-fit h-fit rounded-[0.625rem] p-[2px] from-[#FF7E07] to-[#312B07]">
            <div className="flex justify-start rounded-[0.625rem] bg-black gap-6 px-2 items-center py-3  max-w-[368px] w-full sm:w-[368px]">
              ...
              ></Image>
              <p className="text-2xl text-transparent bg-clip-text  bg-gradient-to-r from-[#FF7E07] to-[#312B07]">
                Brand partnership
              </p>
            </div>
          </div>
        ...
        <Spacer y={6}></Spacer>
        <section className="w-full flex flex-col gap-14 py-10 justify-center items-center">
          <div className="text-center flex flex-col justify-center items-center gap-6 p-8 rounded-[1.25rem] border-1 border-[#35BAEB] max-w-[1048px] max-h-[1021px]">
            <Image
              src="/star.png"
              alt="icon"
              className=" w-[55px] h-[50px]"
            ...
            <Image
              src="/collaborate.png"
              alt="icon"
              className=" max-[329px] w-full sm:w-[329px] h-[417px]"
            ></Image>
          ...
          <div className="text-center flex flex-col justify-center items-center gap-6 p-8 rounded-[1.25rem] border-1 border-[#35BAEB] max-w-[1048px] max-h-[1021px]">
            <Image
              ...
              className=" w-[55px] h-[50px]"
            ></Image>
            <p className="text-[2.5rem] text-white">Performance and Appearance</p>
            <p className=" text-white">
              Lorem ipsum dolor sit amet consectetur. Cras faucibus et elementum
              gravida diam tempus dui dignissim sem. Augue hac eu augue proin
              porttitor tempus tristique.
